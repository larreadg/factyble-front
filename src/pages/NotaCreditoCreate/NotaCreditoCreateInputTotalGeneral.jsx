...
function NotaCreditoInputTotalGeneral({ label, labelPlacement, name, value, variant, className, readOnly }) {
...
NotaCreditoInputTotalGeneral.propTypes = {
...
export default NotaCreditoInputTotalGeneral