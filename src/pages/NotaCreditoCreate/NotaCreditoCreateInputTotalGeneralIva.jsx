...
function NotaCreditoCreateInputTotalGeneralIva({ label, labelPlacement, name, value, variant, className, readOnly }) {
...
NotaCreditoCreateInputTotalGeneralIva.propTypes = {
...
export default NotaCreditoCreateInputTotalGeneralIva