...
function NotaCreditoCreateSelectCajaEstablecimiento({ handleBlur, list }) {
    const {
        values,
        setFieldValue,
    } = useFormikContext()
...
NotaCreditoCreateSelectCajaEstablecimiento.propTypes = {
    handleBlur: PropTypes.func,
    list: PropTypes.array,
}

export default NotaCreditoCreateSelectCajaEstablecimiento